---
name: okf-init
description: Scaffold a new Open Knowledge Format (OKF) knowledge base — a tree of small markdown concept files with YAML frontmatter, a spec, and a validator. Use when the user wants to start an OKF atlas/wiki/knowledge base, structure docs as one-concept-per-file with provenance, or initialize OKF in a repo (optionally into its GitHub wiki).
license: MIT
metadata:
  author: jamditis
  version: "0.1.0"
