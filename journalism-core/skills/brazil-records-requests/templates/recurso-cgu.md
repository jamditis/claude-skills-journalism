...
**Alcance:** apenas órgãos e entidades do Poder Executivo federal.
*Federal executive only. State and municipal denials do not reach CGU.*
...
Órgão: [ÓRGÃO]
Decisões anteriores: [DATAS E FUNDAMENTOS, EM UMA LINHA CADA]

Com fundamento no art. 16 da Lei nº 12.527/2011, interponho recurso contra a
decisão da autoridade máxima do(a) [ÓRGÃO] que manteve a negativa de acesso.
...
[A tabela é deliberada: ela torna visível, em um relance, a mudança de
fundamentos ou o descumprimento de prazos.]

**3. Das razões**

[DESENVOLVA. Escolha um ou dois argumentos, não todos.]

**4. Do precedente**

A CGU já decidiu, no processo [NÚMERO / NUP], que [SÍNTESE DA DECISÃO
ANTERIOR APLICÁVEL AO CASO].
...
*Search CGU's published decisions for the same denial ground before writing.
One correctly cited precedent beats three paragraphs of fresh argument.*

Se o pedido envolver órgão estadual ou municipal, este recurso não se aplica:
