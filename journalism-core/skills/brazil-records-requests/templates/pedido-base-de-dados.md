...
**Uso:** quando o objeto é uma base estruturada, não um documento. É o pedido
com maior taxa de sucesso, porque não exige nenhum trabalho novo do órgão.
...
Com fundamento na Lei nº 12.527/2011, solicito cópia integral da base de
dados [NOME DO SISTEMA OU DA BASE], mantida por este órgão, referente ao
...
- Se você já conhece os campos por uma publicação anterior do órgão, cite-a.
  ...
  *If a prior publication shows the fields, cite it. Hard to claim the
  dataset doesn't exist.*
- Item (c) é o que permite pedir atualizações depois sem refazer tudo.
  *Item (c) is what lets you request refreshes later without starting over.*
