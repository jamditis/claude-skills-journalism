...
|----------|-----------------|-------|
| X (Twitter) | X Pro (paid, behind X Premium+); Brandwatch (paid); pay-per-use API | Free academic/research tier ended early 2023. Pay-per-use replaced the Basic and Pro tiers for new developers in Feb 2026 ($0.005/post read, 2M-read monthly cap); Pro tier $5,000/month for full-archive search; Enterprise ~$42K+/month. Post-2023 ToS explicitly prohibits scraping. |
| Facebook / Instagram | Meta Content Library (academic only, via ICPSR); Junkipedia (free, journalist-friendly); NewsWhip (paid) | CrowdTangle was shut down on Aug 14, 2024 — it does not exist in any form. Meta Content Library replaced it but excludes most journalists; application process runs 2-6 weeks and requires academic or nonprofit affiliation. The Library API gained a paid Verified Data Environment tier in Jan 2026 ($371/team/month + $1,000 project-start fee). |
| TikTok | Research API (academic + vetted journalists); Exolyt, Pentos (paid) | Apply at developers.tiktok.com. Institutional affiliation usually required, especially for EU DSA Article 40 access. Playlist Info and Commercial Content endpoints expanded in 2026. |
