...
| Skill | Description | Updated |
|-------|-------------|--------|
| [document-design](./pdf-playground/skills/document-design/) | Create print-ready HTML proposals, reports, one-pagers, newsletters, slides, flyers, and other PDF-ready documents with reusable brand and layout patterns | Aug 21, 2026 |
